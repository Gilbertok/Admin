...
import com.bograntex.bograntexAdmin.view.AppViewType;
...
public class AppNavigator extends Navigator {
    ...
    private static final AppViewType ERROR_VIEW = AppViewType.CONTABILIDADE;
    ...
    private void initViewChangeListener() {
        addViewChangeListener(new ViewChangeListener() {
            ...
            public void afterViewChange(final ViewChangeEvent event) {
                AppViewType view = AppViewType.getByViewName(event
                        .getViewName());
